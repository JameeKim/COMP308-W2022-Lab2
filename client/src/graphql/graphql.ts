...
export type MyCoursesQuery = { __typename: 'Query', whoami?: { __typename: 'Student', _id: string, courses: Array<{ __typename: 'Course', _id: string, code: string, name: string, section: number, semester: string }> } | null };
